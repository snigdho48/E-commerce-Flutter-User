          ...
          : ListView(
              children: [
                ...
                ListTile(
                  ...
                  title: Text(userProvider.userModel!.phone?.substring(3, 14) ??
                      'Not set yet'),
                  trailing: IconButton(
                    onPressed: () {
                      showSingleTextFieldInputDialog(
                        ...
                        onSubmit: (value) async {
                          if ((value.length == 11 &&
                              ...
                              (value.length == 14 &&
                                  int.tryParse(value..substring(1, 14)) !=
                                      null)) {
                            await Navigator.pushNamed(
                                    context, OtpVerificationPage.routeName,
                                    arguments: value.startsWith('+', 0)
                                        ? value
                                        : "+88$value")
                                .then((map) {
                              try {
                                ...
                                if (map['varified']) {
                                  userProvider.updateUserProfileField(
                                      userFieldPhone, map['phone']);
                                }
                                print(map['varified'].toString());
                              } catch (error) {}
                              ;
                            });
                          } else {
